...
import { getProductInfo, updateProduct } from '../store/slices/productSlice';
...
const UpdateProduct = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getProductInfo({ productId: id, token: userState.token }));
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(updateProduct({ productId: id, body: values, token: userState.token })).then(() => {
